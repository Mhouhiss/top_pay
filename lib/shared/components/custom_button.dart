...
// // 1. Prepare base text style without locking in a dark text color
// final textStyle = labelStyle?.copyWith(
//   color: textColor ?? (variant == ButtonVariant.primary
//       ? (isDisabled ? scheme.onPrimary.withValues(alpha: 0.7) : scheme.onPrimary)
//       : null),
// );
//
// // 2. Prepare icon color
// final iconColor = textColor ?? (variant == ButtonVariant.primary
//     ? (isDisabled ? scheme.onPrimary.withValues(alpha: 0.7) : scheme.onPrimary)
//     : scheme.primary);
//
// Widget content = isLoading
...
//   children: [
//     if (leadingIcon != null) ...[
//       Icon(leadingIcon, size: AppSizes.iconSm, color: iconColor),
//       const SizedBox(width: AppSizes.sm),
//     ],
//     Text(label, style: textStyle), // 👈 Now applies white on primary!
//     if (trailingIcon != null) ...[
//       const SizedBox(width: AppSizes.sm),
//       Icon(trailingIcon, size: AppSizes.iconSm, color: iconColor),
//     ],
//   ],
// );
